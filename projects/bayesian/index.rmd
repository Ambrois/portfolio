...
The accuracy of Bayesian inference depends on how well your chosen model(s) capture the underlying data-generating process. However, in practice, models are approximate and thus somewhat misspecified, with assumptions violated in various degrees. This analysis looks at two examples of mild model misspecification, comparing predictive distributions from correctly specified models with those from simpler misspecified alternatives. 
...
## Example 1. Real data is hierarchical, but we assume flat
...
## Example 2. Real data is dependent, but we assume independent
