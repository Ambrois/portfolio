...
Dot plot showing Mount Everest expedition lengths by year, with each point representing one expedition. Successful and unsuccessful climbs are shown separately, revealing that expedition durations have become more consistent over time, with notable exceptions driven by external disaesters. In 2014, an ice avalanche in the Khumbu Icefall killed several Sherpas and led to the cancellation of much of the climbing season. In 2015, a large earthquake in Nepal triggered avalanches that struck Everest Base Camp, forcing most expeditions to end early.
